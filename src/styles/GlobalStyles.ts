...
const GlobalStyle = createGlobalStyle`
  ...
  @import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&family=Playfair+Display:wght@400;700&family=Permanent+Marker&family=Dancing+Script&family=Kaushan+Script&display=swap');
